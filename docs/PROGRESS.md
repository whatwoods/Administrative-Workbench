...
#### AI Agent 助手 (核心升级) ✅
- [x] **13+ 自动化工具**：覆盖任务、费用、笔记、天气、简报等
- [x] **RAG 知识库问答**：基于本地笔记的语义搜索与问答
- [x] **全局快捷入口**：`Ctrl+Shift+A` 悬浮窗及常驻按钮
- [x] **多模态交互**：集成 Web Speech API 语音输入
- [x] **智能简报**：每日自动聚合任务、支出与天气
- [x] 对话历史管理
- [x] 帮助和命令文档
